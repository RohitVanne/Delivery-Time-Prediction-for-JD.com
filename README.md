...
Order: Order details (e.g., order_ID, user_ID, sku_ID, promise).
Observations: 549,989
Columns: 17
User: User demographics (e.g., user_ID, gender, age).
Observations: 457,298
Columns: 10
Delivery: Delivery details (e.g., order_ID, ship_out_time, arr_time).
Observations: 293,229
Columns: 6
Inventory: Inventory data (e.g., dc_ID, sku_ID, date).
Observations: 136,079
Columns: 3
Network: Network data (e.g., region_ID, dc_ID).
Observations: 56
Columns: 2
